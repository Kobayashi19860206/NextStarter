...
API Routes can be used but some minimal configuration is required. See [this discussion](https://github.com/Kobayashi19860206/NextStarter/issues/4#issuecomment-754030049) for more information.
